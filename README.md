...
- Has 124 integration tests using the real SDK clients, including
...
```bash
# Go (86 tests, race-detector clean)
...
124 integration tests total. Tests use the real GCP client libraries — they
